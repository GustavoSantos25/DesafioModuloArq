...
data class Quadrinho(val id: Int, var title: String, var issueNumber: Double, var description : String, var pageCount : Int,  var prices: ArrayList<Prices>, var thumbnail : Thumbnail, var images : ArrayList<Images>)
